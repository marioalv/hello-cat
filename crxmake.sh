...
key=$KEY
name=$(basename "$dir")
crx="hello-cat-$CURRENT_VERSION-$CHROME$EXTENSION"
pub="$name.pub"
sig="$name.sig"
zip="hello-cat-$CURRENT_VERSION-$CHROME.zip"
xpiFirefox="hello-cat-$CURRENT_VERSION-$FIREFOX.xpi"
